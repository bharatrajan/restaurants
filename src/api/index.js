...
export const getRestaurentsList = (longitude, latitude, successHandler, errorHandler) =>
  fetch( zomatoApiMeta.getURL(longitude, latitude),  {headers : zomatoApiMeta.headers})
